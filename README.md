...
Метод __writeLemmasAndSearchIndexIIntoSql__ при помощи метода __enumOfLemmasAndWritingIntoMap__ перебирают в цикле список страниц для каждого сайта (сайт и список
